...
f,g){c._updateDateTime(g);d.isFunction(a.onChangeMonthYear)&&a.onChangeMonthYear.call(b[0],e,f,g,c)},onClose:function(e,f){!0===c.timeDefined&&""!==b.val()&&c._updateDateTime(f);d.isFunction(a.onClose)&&a.onClose.call(b[0],e,f,c)},timepicker:c});c.amNames=d.map(c._defaults.amNames,function(a){return a.toUpperCase()});c.pmNames=d.map(c._defaults.pmNames,function(a){return a.toUpperCase()});if(null===c._defaults.timezoneList){e=[];for(f=-11;12>=f;f++)e.push((0<=f?"+":"-")+("0"+Math.abs(f).toString()).slice(-2)+
"00");c._defaults.timezoneIso8601&&(e=d.map(e,function(a){return"+0000"==a?"Z":a.substring(0,3)+":"+a.substring(3)}));c._defaults.timezoneList=e}c.timezone=c._defaults.timezone;c.hour=c._defaults.hour;c.minute=c._defaults.minute;c.second=c._defaults.second;c.millisec=c._defaults.millisec;c.ampm="";c.$input=b;a.altField&&(c.$altInput=d(a.altField).css({cursor:"pointer"}).focus(function(){b.trigger("focus")}));if(0===c._defaults.minDate||0===c._defaults.minDateTime)c._defaults.minDate=new Date;if(0===
c._defaults.maxDate||0===c._defaults.maxDateTime)c._defaults.maxDate=new Date;void 0!==c._defaults.minDate&&c._defaults.minDate instanceof Date&&(c._defaults.minDateTime=new Date(c._defaults.minDate.getTime()));void 0!==c._defaults.minDateTime&&c._defaults.minDateTime instanceof Date&&(c._defaults.minDate=new Date(c._defaults.minDateTime.getTime()));void 0!==c._defaults.maxDate&&c._defaults.maxDate instanceof Date&&(c._defaults.maxDateTime=new Date(c._defaults.maxDate.getTime()));void 0!==c._defaults.maxDateTime&&
c._defaults.maxDateTime instanceof Date&&(c._defaults.maxDate=new Date(c._defaults.maxDateTime.getTime()));return c},_addTimePicker:function(b){var a=this.$altInput&&this._defaults.altFieldTimeOnly?this.$input.val()+" "+this.$altInput.val():this.$input.val();this.timeDefined=this._parseTime(a);this._limitMinMaxDateTime(b,!1);this._injectTimePicker()},_parseTime:function(b,a){this.inst||(this.inst=d.datepicker._getInst(this.$input[0]));if(a||!this._defaults.timeOnly){var c=d.datepicker._get(this.inst,
"dateFormat");try{var e=u(c,this._defaults.timeFormat,b,d.datepicker._getFormatConfig(this.inst),this._defaults);if(!e.timeObj)return!1;d.extend(this,e.timeObj)}catch(f){return!1}}else{c=d.datepicker.parseTime(this._defaults.timeFormat,b,this._defaults);if(!c)return!1;d.extend(this,c)}return!0},_injectTimePicker:function(){var b=this.inst.dpDiv,a=this._defaults,c=this,e=parseInt(a.hourMax-(a.hourMax-a.hourMin)%a.stepHour,10),f=parseInt(a.minuteMax-(a.minuteMax-a.minuteMin)%a.stepMinute,10),g=parseInt(a.secondMax-
(a.secondMax-a.secondMin)%a.stepSecond,10),l=parseInt(a.millisecMax-(a.millisecMax-a.millisecMin)%a.stepMillisec,10),i=this.inst.id.toString().replace(/([^A-Za-z0-9_])/g,"");if(0===b.find("div#ui-timepicker-div-"+i).length&&a.showTimepicker){var h='<div class="ui-timepicker-div" id="ui-timepicker-div-'+i+'"><dl><dt class="ui_tpicker_time_label" id="ui_tpicker_time_label_'+i+'"'+(a.showTime?"":' style="display:none;"')+">"+a.timeText+'</dt><dd class="ui_tpicker_time" id="ui_tpicker_time_'+i+'"'+(a.showTime?
"":' style="display:none;"')+'></dd><dt class="ui_tpicker_hour_label" id="ui_tpicker_hour_label_'+i+'"'+(a.showHour?"":' style="display:none;"')+">"+a.hourText+"</dt>",s=0,q=0,o=0,m=0,n=null,h=h+('<dd class="ui_tpicker_hour"><div id="ui_tpicker_hour_'+i+'"'+(a.showHour?"":' style="display:none;"')+"></div>");if(a.showHour&&0<a.hourGrid){for(var h=h+'<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>',j=a.hourMin;j<=e;j+=parseInt(a.hourGrid,10)){s++;var p=a.ampm&&12<j?j-12:j;
10>p&&(p="0"+p);a.ampm&&(p=0===j?"12a":12>j?p+"a":p+"p");h+="<td>"+p+"</td>"}h+="</tr></table></div>"}h=h+"</dd>"+('<dt class="ui_tpicker_minute_label" id="ui_tpicker_minute_label_'+i+'"'+(a.showMinute?"":' style="display:none;"')+">"+a.minuteText+'</dt><dd class="ui_tpicker_minute"><div id="ui_tpicker_minute_'+i+'"'+(a.showMinute?"":' style="display:none;"')+"></div>");if(a.showMinute&&0<a.minuteGrid){h+='<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>';for(j=a.minuteMin;j<=
f;j+=parseInt(a.minuteGrid,10))q++,h+="<td>"+(10>j?"0":"")+j+"</td>";h+="</tr></table></div>"}h=h+"</dd>"+('<dt class="ui_tpicker_second_label" id="ui_tpicker_second_label_'+i+'"'+(a.showSecond?"":' style="display:none;"')+">"+a.secondText+'</dt><dd class="ui_tpicker_second"><div id="ui_tpicker_second_'+i+'"'+(a.showSecond?"":' style="display:none;"')+"></div>");if(a.showSecond&&0<a.secondGrid){h+='<div style="padding-left: 1px"><table><tr>';for(j=a.secondMin;j<=g;j+=parseInt(a.secondGrid,10))o++,
h+="<td>"+(10>j?"0":"")+j+"</td>";h+="</tr></table></div>"}h=h+"</dd>"+('<dt class="ui_tpicker_millisec_label" id="ui_tpicker_millisec_label_'+i+'"'+(a.showMillisec?"":' style="display:none;"')+">"+a.millisecText+'</dt><dd class="ui_tpicker_millisec"><div id="ui_tpicker_millisec_'+i+'"'+(a.showMillisec?"":' style="display:none;"')+"></div>");if(a.showMillisec&&0<a.millisecGrid){h+='<div style="padding-left: 1px"><table><tr>';for(j=a.millisecMin;j<=l;j+=parseInt(a.millisecGrid,10))m++,h+="<td>"+(10>
...
""),f=c-a;b.css({width:f,marginLeft:e*f/c+"%"})})}},0)}}},_limitMinMaxDateTime:function(b,a){var c=this._defaults,e=new Date(b.selectedYear,b.selectedMonth,b.selectedDay);if(this._defaults.showTimepicker){if(null!==d.datepicker._get(b,"minDateTime")&&void 0!==d.datepicker._get(b,"minDateTime")&&e){var f=d.datepicker._get(b,"minDateTime"),g=new Date(f.getFullYear(),f.getMonth(),f.getDate(),0,0,0,0);if(null===this.hourMinOriginal||null===this.minuteMinOriginal||null===this.secondMinOriginal||null===
this.millisecMinOriginal)this.hourMinOriginal=c.hourMin,this.minuteMinOriginal=c.minuteMin,this.secondMinOriginal=c.secondMin,this.millisecMinOriginal=c.millisecMin;b.settings.timeOnly||g.getTime()==e.getTime()?(this._defaults.hourMin=f.getHours(),this.hour<=this._defaults.hourMin?(this.hour=this._defaults.hourMin,this._defaults.minuteMin=f.getMinutes(),this.minute<=this._defaults.minuteMin?(this.minute=this._defaults.minuteMin,this._defaults.secondMin=f.getSeconds()):this.second<=this._defaults.secondMin?
...
this._defaults.millisecMin=this.millisecMinOriginal)}if(null!==d.datepicker._get(b,"maxDateTime")&&void 0!==d.datepicker._get(b,"maxDateTime")&&e){f=d.datepicker._get(b,"maxDateTime");g=new Date(f.getFullYear(),f.getMonth(),f.getDate(),0,0,0,0);if(null===this.hourMaxOriginal||null===this.minuteMaxOriginal||null===this.secondMaxOriginal)this.hourMaxOriginal=c.hourMax,this.minuteMaxOriginal=c.minuteMax,this.secondMaxOriginal=c.secondMax,this.millisecMaxOriginal=c.millisecMax;b.settings.timeOnly||g.getTime()==
...
this.millisecMaxOriginal)):(this._defaults.minuteMax=this.minuteMaxOriginal,this._defaults.secondMax=this.secondMaxOriginal,this._defaults.millisecMax=this.millisecMaxOriginal)):(this._defaults.hourMax=this.hourMaxOriginal,this._defaults.minuteMax=this.minuteMaxOriginal,this._defaults.secondMax=this.secondMaxOriginal,this._defaults.millisecMax=this.millisecMaxOriginal)}void 0!==a&&!0===a&&(c=parseInt(this._defaults.hourMax-(this._defaults.hourMax-this._defaults.hourMin)%this._defaults.stepHour,10),
...
(b[f[g].toString().charAt(0)]=g+1);f="";e=a.match(RegExp(e,"i"));a={hour:0,minute:0,second:0,millisec:0};if(e){-1!==b.t&&(void 0===e[b.t]||0===e[b.t].length?(f="",a.ampm=""):(f=-1!==d.inArray(e[b.t],c.amNames)?"AM":"PM",a.ampm=c["AM"==f?"amNames":"pmNames"][0]));-1!==b.h&&(a.hour="AM"==f&&"12"==e[b.h]?0:"PM"==f&&"12"!=e[b.h]?parseInt(e[b.h],10)+12:Number(e[b.h]));-1!==b.m&&(a.minute=Number(e[b.m]));-1!==b.s&&(a.second=Number(e[b.s]));-1!==b.l&&(a.millisec=Number(e[b.l]));if(-1!==b.z&&void 0!==e[b.z]){b=
e[b.z].toUpperCase();switch(b.length){case 1:b=c.timezoneIso8601?"Z":"+0000";break;case 5:c.timezoneIso8601&&(b="0000"==b.substring(1)?"Z":b.substring(0,3)+":"+b.substring(3));break;case 6:c.timezoneIso8601?"00:00"==b.substring(1)&&(b="Z"):b="Z"==b||"00:00"==b.substring(1)?"+0000":b.replace(/:/,"")}a.timezone=b}return a}return!1};d.datepicker.formatTime=function(b,a,c){var c=c||{},c=d.extend(d.timepicker._defaults,c),a=d.extend({hour:0,minute:0,second:0,millisec:0,timezone:"+0000"},a),e=c.amNames[0],
f=parseInt(a.hour,10);c.ampm&&(11<f&&(e=c.pmNames[0],12<f&&(f%=12)),0===f&&(f=12));b=b.replace(/(?:hh?|mm?|ss?|[tT]{1,2}|[lz])/g,function(b){switch(b.toLowerCase()){case "hh":return("0"+f).slice(-2);case "h":return f;case "mm":return("0"+a.minute).slice(-2);case "m":return a.minute;case "ss":return("0"+a.second).slice(-2);case "s":return a.second;case "l":return("00"+a.millisec).slice(-3);case "z":return a.timezone;case "t":case "tt":if(c.ampm){b.length==1&&(e=e.charAt(0));return b.charAt(0)=="T"?
e.toUpperCase():e.toLowerCase()}return""}});return b=d.trim(b)};d.datepicker._base_selectDate=d.datepicker._selectDate;d.datepicker._selectDate=function(b,a){var c=this._getInst(d(b)[0]),e=this._get(c,"timepicker");e?(e._limitMinMaxDateTime(c,!0),c.inline=c.stay_open=!0,this._base_selectDate(b,a),c.inline=c.stay_open=!1,this._notifyChange(c),this._updateDatepicker(c)):this._base_selectDate(b,a)};d.datepicker._base_updateDatepicker=d.datepicker._updateDatepicker;d.datepicker._updateDatepicker=function(b){var a=
b.input[0];if(!d.datepicker._curInst||!(d.datepicker._curInst!=b&&d.datepicker._datepickerShowing&&d.datepicker._lastInput!=a))if("boolean"!==typeof b.stay_open||!1===b.stay_open)if(this._base_updateDatepicker(b),a=this._get(b,"timepicker"))a._addTimePicker(b),a._defaults.useLocalTimezone&&(t(a,new Date(b.selectedYear,b.selectedMonth,b.selectedDay,12)),a._onTimeChange())};d.datepicker._base_doKeyPress=d.datepicker._doKeyPress;d.datepicker._doKeyPress=function(b){var a=d.datepicker._getInst(b.target),
c=d.datepicker._get(a,"timepicker");if(c&&d.datepicker._get(a,"constrainInput")){var e=c._defaults.ampm,a=d.datepicker._possibleChars(d.datepicker._get(a,"dateFormat")),c=c._defaults.timeFormat.toString().replace(/[hms]/g,"").replace(/TT/g,e?"APM":"").replace(/Tt/g,e?"AaPpMm":"").replace(/tT/g,e?"AaPpMm":"").replace(/T/g,e?"AP":"").replace(/tt/g,e?"apm":"").replace(/t/g,e?"ap":"")+" "+c._defaults.separator+c._defaults.timeSuffix+(c._defaults.showTimezone?c._defaults.timezoneList.join(""):"")+c._defaults.amNames.join("")+
c._defaults.pmNames.join("")+a,e=String.fromCharCode(void 0===b.charCode?b.keyCode:b.charCode);return b.ctrlKey||" ">e||!a||-1<c.indexOf(e)}return d.datepicker._base_doKeyPress(b)};d.datepicker._base_doKeyUp=d.datepicker._doKeyUp;d.datepicker._doKeyUp=function(b){var a=d.datepicker._getInst(b.target),c=d.datepicker._get(a,"timepicker");if(c&&c._defaults.timeOnly&&a.input.val()!=a.lastVal)try{d.datepicker._updateDatepicker(a)}catch(e){d.datepicker.log(e)}return d.datepicker._base_doKeyUp(b)};d.datepicker._base_gotoToday=
d.datepicker._gotoToday;d.datepicker._gotoToday=function(b){var a=this._getInst(d(b)[0]),c=a.dpDiv;this._base_gotoToday(b);b=this._get(a,"timepicker");t(b);this._setTime(a,new Date);d(".ui-datepicker-today",c).click()};d.datepicker._disableTimepickerDatepicker=function(b){var a=this._getInst(b);if(a){var c=this._get(a,"timepicker");d(b).datepicker("getDate");c&&(c._defaults.showTimepicker=!1,c._updateDateTime(a))}};d.datepicker._enableTimepickerDatepicker=function(b){var a=this._getInst(b);if(a){var c=
this._get(a,"timepicker");d(b).datepicker("getDate");c&&(c._defaults.showTimepicker=!0,c._addTimePicker(a),c._updateDateTime(a))}};d.datepicker._setTime=function(b,a){var c=this._get(b,"timepicker");if(c){var e=c._defaults,d=a?a.getHours():e.hour,g=a?a.getMinutes():e.minute,l=a?a.getSeconds():e.second,i=a?a.getMilliseconds():e.millisec,h=d===e.hourMin,m=g===e.minuteMin,q=l===e.secondMin,o=!1;if(d<e.hourMin||d>e.hourMax)o=!0;else if((g<e.minuteMin||g>e.minuteMax)&&h)o=!0;else if((l<e.secondMin||l>
e.secondMax)&&h&&m)o=!0;else if((i<e.millisecMin||i>e.millisecMax)&&h&&m&&q)o=!0;o&&(d=e.hourMin,g=e.minuteMin,l=e.secondMin,i=e.millisecMin);c.hour=d;c.minute=g;c.second=l;c.millisec=i;c.hour_slider&&c.hour_slider.slider("value",d);c.minute_slider&&c.minute_slider.slider("value",g);c.second_slider&&c.second_slider.slider("value",l);c.millisec_slider&&c.millisec_slider.slider("value",i);c._onTimeChange();c._updateDateTime(b)}};d.datepicker._setTimeDatepicker=function(b,a,c){if(b=this._getInst(b)){var e=
this._get(b,"timepicker");e&&(this._setDateFromField(b),a&&("string"==typeof a?(e._parseTime(a,c),a=new Date,a.setHours(e.hour,e.minute,e.second,e.millisec)):a=new Date(a.getTime()),"Invalid Date"==a.toString()&&(a=void 0),this._setTime(b,a)))}};d.datepicker._base_setDateDatepicker=d.datepicker._setDateDatepicker;d.datepicker._setDateDatepicker=function(b,a){var c=this._getInst(b);if(c){var e=a instanceof Date?new Date(a.getTime()):a;this._updateDatepicker(c);this._base_setDateDatepicker.apply(this,
arguments);this._setTimeDatepicker(b,e,!0)}};d.datepicker._base_getDateDatepicker=d.datepicker._getDateDatepicker;d.datepicker._getDateDatepicker=function(b,a){var c=this._getInst(b);if(c){var e=this._get(c,"timepicker");return e?(this._setDateFromField(c,a),(c=this._getDate(c))&&e._parseTime(d(b).val(),e.timeOnly)&&c.setHours(e.hour,e.minute,e.second,e.millisec),c):this._base_getDateDatepicker(b,a)}};d.datepicker._base_parseDate=d.datepicker.parseDate;d.datepicker.parseDate=function(b,a,c){a=w(b,
a,c);return d.datepicker._base_parseDate(b,a[0],c)};d.datepicker._base_formatDate=d.datepicker._formatDate;d.datepicker._formatDate=function(b){var a=this._get(b,"timepicker");return a?(a._updateDateTime(b),a.$input.val()):this._base_formatDate(b)};d.datepicker._base_optionDatepicker=d.datepicker._optionDatepicker;d.datepicker._optionDatepicker=function(b,a,c){var e=this._getInst(b);if(!e)return null;if(e=this._get(e,"timepicker")){var d=null,g=null,l=null;"string"==typeof a?"minDate"===a||"minDateTime"===
a?d=c:"maxDate"===a||"maxDateTime"===a?g=c:"onSelect"===a&&(l=c):"object"==typeof a&&(a.minDate?d=a.minDate:a.minDateTime?d=a.minDateTime:a.maxDate?g=a.maxDate:a.maxDateTime&&(g=a.maxDateTime));d?(d=0===d?new Date:new Date(d),e._defaults.minDate=d,e._defaults.minDateTime=d):g?(g=0===g?new Date:new Date(g),e._defaults.maxDate=g,e._defaults.maxDateTime=g):l&&(e._defaults.onSelect=l)}return void 0===c?this._base_optionDatepicker(b,a):this._base_optionDatepicker(b,a,c)};var w=function(b,a,c){try{d.datepicker._base_parseDate(b,
a,c)}catch(e){if(0<=e.indexOf(":"))return b=a.length-(e.length-e.indexOf(":")-2),a.substring(b),[a.substring(0,b),a.substring(b)];throw e;}return[a,""]},u=function(b,a,c,e,f){c=w(b,c,e);b=d.datepicker._base_parseDate(b,c[0],e);if(""!==c[1]){e=c[1];c=f&&f.separator?f.separator:d.timepicker._defaults.separator;if(0!==e.indexOf(c))throw"Missing time separator";e=e.substring(c.length);a=d.datepicker.parseTime(a,e,f);if(null===a)throw"Wrong time format";return{date:b,timeObj:a}}return{date:b}},t=function(b,
a){if(b&&b.timezone_select){b._defaults.useLocalTimezone=!0;var c=v("undefined"!==typeof a?a:new Date);b._defaults.timezoneIso8601&&(c=c.substring(0,3)+":"+c.substring(3));b.timezone_select.val(c)}},v=function(b){b=-10100*b.getTimezoneOffset()/60;return(0<=b?"+":"-")+Math.abs(b).toString().substr(1)};d.timepicker=new m;d.timepicker.version="1.0.1"}})(jQuery);$("#test").datetimepicker({ampm:!1});